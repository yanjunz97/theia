...
# Code structure is following the Kubernetes Python Client library
# (https://github.com/kubernetes-client/python).
# This file could be changed to auto-generated by using openAPI generator
# in the future like the K8s python lib.
...
class ServiceReference(object):
    attribute_types = {"name": "string", "namespace": "string"}
...
class GroupStatus(object):
    attribute_types = {"conditions": "list[GroupCondition]"}
...
class NetworkPolicyStatus(object):
    ...
    def __init__(
        ...
        current_nodes_realized=None,
        desired_nodes_realized=None,
    ):
        self.phase = phase
