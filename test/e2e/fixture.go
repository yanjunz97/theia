...
func setupTestForFlowVisibility(tb testing.TB, withSparkOperator bool, withLocalPv bool) (*TestData, bool, bool, error) {
	...
	chSvcIP, err := testData.deployFlowVisibility(withSparkOperator, withLocalPv)
	if err != nil {
		return testData, v4Enabled, v6Enabled, err
	}
