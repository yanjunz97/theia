...
func getClickHouseSecret(client kubernetes.Interface, namespace string) (username string, password string, err error) {
...
func getClickHouseURL() (url string, err error) {
	...
	if baseURL == "" || username == "" || password == "" {
		...
		username, password, err = getClickHouseSecret(client, env.GetTheiaNamespace())
		if err != nil {
			return url, err
		}
	}
